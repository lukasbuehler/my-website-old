...
(function (State) {
    ...
    State["PutOff"] = "put_off";
    State["Download"] = "download";
    State["Visit"] = "visit";
    State["NewVersion"] = "new_version";
    State["Watch"] = "watch_now";
})(State || (State = {}));
function setLoadingErrorVisibility(visible) {
    if (visible) {
...
function parseCardJson(cardJson) {
    ...
    let card = {
        ...
        text: multi_lang_1.makeMultilangResource("text", cardJson.text_en || "", "text", cardJson.text_de || "", "text", cardJson.text_ch || ""),
...
},{"./multi_lang":34}],32:[function(require,module,exports){
"use strict";
...
},{"./cards":31,"./navbar":35,"./smoothScroll":36}],33:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"moment":30}],34:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const i18n = require("i18next");
const XHR = require("i18next-xhr-backend");
const LanguageDetector = require("i18next-browser-languagedetector");
const momentHelper_1 = require("./momentHelper");
function makeMultilangResource(key_en, text_en, key_de, text_de, key_ch, text_ch) {
    return {
        en: {
            [key_en]: text_en
        },
...
let parameterGetCallbacks = {
    "age": function () {
        return momentHelper_1.getAge("19.06.1998");
    }
};
const instance = i18n
    .use(XHR)
...
},{"./momentHelper":33,"i18next":29,"i18next-browser-languagedetector":10,"i18next-xhr-backend":14}],35:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
